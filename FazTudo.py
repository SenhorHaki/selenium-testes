...
while (True):
	...
	while (True):
		...
		if navegador.current_url == 'http://www.infordu.com/#/home':
			sleep(1)
			b1 = navegador.find_element_by_xpath('/html/body/div/div[2]/div/div[2]/div[2]/div')
			bl.click()1
			b2 = navegador.find_element_by_xpath('/html/body/div/div[2]/div/div[3]/div[2]/div')
			b3 = navegador.find_element_by_xpath('/html/body/div/div[2]/div/div[4]/div[2]/div')
